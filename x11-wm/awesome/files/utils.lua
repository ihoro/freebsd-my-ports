...
function utils.lookup_icon(icon_file)
    ...
    if icon_file:sub(1, 1) == '/' and is_format_supported(icon_file) then
        ...
        if icon_theme then
            table.insert(icon_theme_paths, '/usr/local/share/icons/' .. icon_theme .. '/')
            -- TODO also look in parent icon themes, as in freedesktop.org specification
        end
        table.insert(icon_theme_paths, '/usr/local/share/icons/hicolor/') -- fallback theme
        ...
        table.insert(icon_path, '/usr/local/share/icons/')
        table.insert(icon_path, '/home/phantom/.local/share/icons/')
